...
---
Hello! I am a Ph.D. student in EECS at [MIT](https://www.eecs.mit.edu/), working with Prof. [Paris Smaragdis](https://www.mit.edu/~paris/).  I received my B.S. and M.S. in Electrical and Electronic Engineering from [Yonsei University](https://www.yonsei.ac.kr/sites/en_sc/index.do) (South Korea) and worked at [DSPAI Lab](http://dsp.yonsei.ac.kr/) under Prof. [Hong-Goo Kang](https://scholar.google.com/citations?user=YsD8KCYAAAAJ&hl=en). My primary research goal is to bridge the gap between classic signal processing and modern deep learning, with interests spanning `audio and speech processing`, `audio compression`, and `generative models`.
